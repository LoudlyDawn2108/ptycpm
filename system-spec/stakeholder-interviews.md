...
> **Ghi chú thiết kế – FEAT 2.4:** "Nhóm nghiệp vụ" trong FEAT 2.4 chỉ các vai trò chức năng được hệ thống định nghĩa sẵn, tương ứng với phân nhóm tác nhân: Quản trị viên, Phòng TCCB, Phòng TCKT, Cán bộ nhân sự (Cán bộ/Giảng viên/Nhân viên). Mỗi nhóm nghiệp vụ quy định tập quyền truy cập các chức năng hệ thống khác nhau.
...
| STRQ 13 | Approved | High | Critical | Low | High | 4 | Ràng buộc pháp lý — bảo vệ dữ liệu cá nhân (Nghị định 13/2023/NĐ-CP) |
| STRQ 14 | Approved | High | Critical | Medium | High | 4 | Yêu cầu triển khai — ứng dụng web đa người dùng |
| STRQ 15 | Approved | High | Critical | Medium | Medium | 5 | Yêu cầu cơ cấu tổ chức — cấu trúc phân cấp đơn vị |
...
| FEAT 1.5 | Approved | High | Critical | Medium | High | Medium | 4 | Iteration 1 | Team 1 (BA) | STRQ 14 | Thêm chi tiết |
...
| FEAT 3.1 | Approved | High | Critical | Medium | Medium | Medium | 5 | Iteration 1 | Team 1 (BA) | STRQ 15 | Thêm chi tiết |
...
| FEAT 13.1 | Approved | High | Critical | Low | High | Medium | 4 | Iteration 2 | Team 1 (BA) | STRQ 13 | Làm cho đầy đủ, Phân tách |
| FEAT 13.2 | Approved | High | Critical | Medium | Medium | High | 5 | Iteration 2 | Team 1 (BA) | STRQ 13 | Làm cho đầy đủ, Phân tách |
...
| Iteration 2 | 20 | 68 | Quản lý hồ sơ nhân sự, hợp đồng, đánh giá, điều chuyển / bổ nhiệm, bảo vệ dữ liệu cá nhân |
