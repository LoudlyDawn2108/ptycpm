...
| STT | ID | Tên yêu cầu | Yếu tố chất lượng chính | FEAT liên quan |
|-----|----|-------------|--------------------------|----------------|
| 1 | SUPL-P01 | Thời gian phản hồi giao diện nghiệp vụ | Performance → Response time | FEAT 7.1, FEAT 7.2, FEAT 7.3, FEAT 8.3, FEAT 8.4, FEAT 8.7 |
| 2 | SUPL-P02 | Khả năng phục vụ người dùng đồng thời | Performance → Capacity | FEAT 7.1–8.9 |
| 3 | SUPL-P03 | Thời gian tổng hợp và hiển thị hồ sơ nhân sự | Performance → Response time | FEAT 8.7, FEAT 8.8 |
| 4 | SUPL-P04 | Hiệu năng tìm kiếm và lọc | Performance → Response time | FEAT 8.1, FEAT 8.2 |
| 5 | SUPL-P05 | Hiệu năng upload/download tệp đính kèm | Performance → Response time | FEAT 7.1, FEAT 7.2, FEAT 7.3, FEAT 8.3, FEAT 8.4, FEAT 8.7 |
| 6 | SUPL-P06 | Hiệu năng xuất dữ liệu Excel | Performance → Response time | FEAT 8.8 |
| 7 | SUPL-R02 | Thời gian khôi phục dịch vụ sau sự cố | Performance → Recovery time | FEAT 7.1–8.9 |
| 8 | SUPL-R03b | Thời gian phục hồi từ bản sao lưu | Performance → Recovery time | FEAT 7.1–8.9 |

> **Ghi chú phân loại:** `SUPL-R02` và `SUPL-R03b` được giữ nguyên tiền tố ID gốc để tránh phá vỡ tham chiếu ở các tài liệu liên quan, nhưng **primary classification** của hai yêu cầu này thuộc **Performance → Recovery time**.

### Chi tiết độ đo và tiêu chuẩn đáp ứng

#### SUPL-P01: Thời gian phản hồi giao diện nghiệp vụ
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Performance → Response time |
| **Phát biểu yêu cầu** | Hệ thống phải hoàn thành thao tác xem danh sách, xem chi tiết, thêm mới hoặc chỉnh sửa trên các màn hình hợp đồng và hồ sơ nhân sự trong ngưỡng thời gian phản hồi quy định theo tải đồng thời. |
...
#### SUPL-P02: Khả năng phục vụ người dùng đồng thời
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Performance → Capacity |
| **Phát biểu yêu cầu** | Hệ thống phải hỗ trợ tối thiểu **100 người dùng đồng thời** trong giờ cao điểm mà không làm thời gian phản hồi tăng quá **50%** so với tải một người dùng. |
| **Importance** | Mandatory |
| **Satisfaction Shape** | Medium |
| **Verification** | Test |
| **Source** | FEAT 7.1–8.9 |
...
#### SUPL-P03: Thời gian tổng hợp và hiển thị hồ sơ nhân sự
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Performance → Response time |
| **Phát biểu yêu cầu** | Hệ thống phải hiển thị chi tiết hồ sơ nhân sự và chuẩn bị dữ liệu phục vụ in hoặc xuất hồ sơ trong các ngưỡng thời gian quy định. |
| **Importance** | Desirable |
| **Satisfaction Shape** | Medium |
| **Verification** | Test |
| **Source** | FEAT 8.7, FEAT 8.8 |
| **Độ đo yêu cầu** | - **Employee Profile Detail Load Time** (giây)<br>- **Profile Print Preparation Time** (giây) |
| **Tiêu chuẩn đáp ứng** | - **Employee Profile Detail Load Time ≤ 5 giây** tại mức **≤ 10 người dùng đồng thời**<br>- **Profile Print Preparation Time ≤ 10 giây** tại mức **≤ 10 người dùng đồng thời** |
| **Lý do chọn độ đo** | FEAT 8.7 và FEAT 8.8 thuộc phạm vi hồ sơ nhân sự do Tùng phụ trách, nên requirement này được thu hẹp về thời gian hiển thị hồ sơ chi tiết và chuẩn bị dữ liệu phục vụ in/xuất hồ sơ. Việc đặt điều kiện tải giúp ngưỡng đo kiểm rõ ràng và bám đúng phạm vi FEAT 7–8 thay vì dùng sai sang phân hệ thống kê tổng quát. |
| **Phương pháp đo** | Đo thời gian từ lúc người dùng mở hồ sơ chi tiết đến khi toàn bộ dữ liệu hồ sơ sẵn sàng hiển thị; đo thời gian từ lúc người dùng chọn in hồ sơ đến khi dữ liệu sẵn sàng cho bước in hoặc sinh tài liệu đầu ra. |
...
|---|---|
| **Yếu tố chất lượng chính** | Performance → Response time |
| **Phát biểu yêu cầu** | Hệ thống phải trả kết quả tìm kiếm và lọc danh sách hồ sơ nhân sự trong các ngưỡng thời gian quy định theo quy mô dữ liệu. |
| **Importance** | Mandatory |
| **Satisfaction Shape** | Medium |
| **Verification** | Test |
...
#### SUPL-P05: Hiệu năng upload/download tệp đính kèm
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Performance → Response time |
| **Phát biểu yêu cầu** | Hệ thống phải hoàn thành upload và download các tệp đính kèm của hồ sơ nhân sự và hợp đồng trong các ngưỡng thời gian quy định trên môi trường mạng LAN. |
| **Importance** | Desirable |
| **Satisfaction Shape** | Medium |
| **Verification** | Test |
| **Source** | FEAT 7.1, FEAT 7.2, FEAT 7.3, FEAT 8.3, FEAT 8.4, FEAT 8.7 |
...
#### SUPL-P06: Hiệu năng xuất dữ liệu Excel
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Performance → Response time |
| **Phát biểu yêu cầu** | Hệ thống phải hoàn thành xuất dữ liệu hồ sơ nhân sự ra Excel trong các ngưỡng thời gian quy định theo số lượng bản ghi. |
| **Importance** | Desirable |
| **Satisfaction Shape** | Medium |
| **Verification** | Test |
| **Source** | FEAT 8.8 |
...
#### SUPL-R02: Thời gian khôi phục dịch vụ sau sự cố
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Performance → Recovery time |
| **Phát biểu yêu cầu** | Sau sự cố **crash** hoặc **restart**, hệ thống phải phục hồi khả năng phục vụ request thành công trong tối đa **15 phút**, với thời gian khởi động lại toàn bộ stack không quá **10 phút**. |
| **Importance** | Mandatory |
...
#### SUPL-R03b: Thời gian phục hồi từ bản sao lưu
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Performance → Recovery time |
| **Phát biểu yêu cầu** | Hệ thống phải phục hồi dữ liệu từ bản sao lưu gần nhất và sẵn sàng phục vụ trong tối đa **4 giờ**. |
| **Importance** | Mandatory |
| **Satisfaction Shape** | Sharp |
| **Verification** | Test |
| **Source** | FEAT 7.1–8.9 |
...
| STT | ID | Tên yêu cầu | Yếu tố chất lượng chính | FEAT liên quan |
|-----|----|-------------|--------------------------|----------------|
| 1 | SUPL-R01 | Tính sẵn sàng dịch vụ | Reliability → Availability | FEAT 7.1–8.9 |
| 2 | SUPL-R03a | Sao lưu dữ liệu định kỳ | Reliability → Recoverability | FEAT 7.1–8.9 |
| 3 | SUPL-R04 | Tính nhất quán dữ liệu giao dịch | Reliability → Correctness | FEAT 7.1–8.9 |
| 4 | SUPL-R05 | Khôi phục dữ liệu nhập dở khi phiên hết hạn | Reliability → Recoverability | FEAT 7.1–8.9 |

> **Ghi chú phân loại:** `SUPL-R02` và phần **RTO** của yêu cầu sao lưu cũ đã được chuyển sang **Section 6.6** vì primary concern của chúng là **thời gian khôi phục dịch vụ**.

### Chi tiết độ đo và tiêu chuẩn đáp ứng

#### SUPL-R01: Tính sẵn sàng dịch vụ
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Reliability → Availability |
| **Phát biểu yêu cầu** | Hệ thống phải sẵn sàng phục vụ trong khung giờ **7:00–22:00** hằng ngày với tỷ lệ **uptime tối thiểu 99,5%** trên tổng thời gian phục vụ trong tháng, không tính thời gian bảo trì theo kế hoạch. |
| **Importance** | Mandatory |
| **Satisfaction Shape** | Sharp |
| **Verification** | Analysis |
| **Source** | FEAT 7.1–8.9 |
| **Độ đo yêu cầu** | - **Uptime** (%)<br>- **Downtime** (giờ/tháng trong khung giờ phục vụ) |
| **Tiêu chuẩn đáp ứng** | - **Uptime ≥ 99,5%/tháng** trong khung giờ **7:00–22:00**<br>- **Downtime ≤ 2,25 giờ/tháng**, không tính bảo trì theo kế hoạch |
...
#### SUPL-R03a: Sao lưu dữ liệu định kỳ
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Reliability → Recoverability |
| **Phát biểu yêu cầu** | Hệ thống phải sao lưu dữ liệu tự động ít nhất mỗi **24 giờ**, lưu giữ bản sao lưu tối thiểu **30 ngày** và đạt tỷ lệ backup thành công tối thiểu **99%**. |
| **Importance** | Mandatory |
| **Satisfaction Shape** | Sharp |
| **Verification** | Test |
| **Source** | FEAT 7.1–8.9 |
...
#### SUPL-R04: Tính nhất quán dữ liệu giao dịch
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Reliability → Correctness |
| **Phát biểu yêu cầu** | Các thao tác cập nhật dữ liệu quan trọng phải bảo đảm nguyên tắc **toàn bộ hoặc không thực hiện phần nào**; nếu một bước thất bại, hệ thống không được ghi nhận thay đổi dở dang và phải khôi phục dữ liệu về trạng thái trước thao tác. |
| **Importance** | Mandatory |
| **Satisfaction Shape** | Sharp |
| **Verification** | Test |
| **Source** | FEAT 7.1–8.9 |
| **Độ đo yêu cầu** | - **Data Inconsistency Count** (số trường hợp)<br>- **Integrity Protection Coverage** (%) |
| **Tiêu chuẩn đáp ứng** | - **Data Inconsistency Count = 0**<br>- **Integrity Protection Coverage = 100%** cho các nhóm nghiệp vụ: **hợp đồng, hồ sơ nhân sự, thay đổi trạng thái** |
...
#### SUPL-R05: Khôi phục dữ liệu nhập dở khi phiên hết hạn
| Thuộc tính | Nội dung |
|---|---|
| **Yếu tố chất lượng chính** | Reliability → Recoverability |
| **Phát biểu yêu cầu** | Đối với form có dữ liệu đã nhập nhưng chưa lưu, hệ thống phải cảnh báo tối thiểu **5 phút** trước khi phiên tự động hết hạn và phải khôi phục dữ liệu nháp gần nhất sau khi người dùng đăng nhập lại trong ít nhất **95%** trường hợp kiểm thử. |
| **Importance** | Desirable |
| **Satisfaction Shape** | Medium |
| **Verification** | Test |
| **Source** | FEAT 7.1–8.9 |
...
| **Lý do chọn độ đo** | Với biểu mẫu nhân sự nhiều trường, việc mất toàn bộ dữ liệu đã nhập là rất tốn thời gian và dễ gây bức xúc cho người dùng, nên hệ thống phải cảnh báo trước và khôi phục bản nháp ở mức cao. Ngưỡng 95% thực tế hơn 100% tuyệt đối vì vẫn có thể có các tình huống ngoài kiểm soát như người dùng đóng tab cưỡng bức hoặc trình duyệt xóa dữ liệu cục bộ. |
...
| **Đại lượng thay thế (nếu cần)** | Kiểm thử nhị phân Có/Không đối với popup cảnh báo trước khi hết phiên và kiểm tra sự tồn tại của bản nháp lưu tạm trên trình duyệt hoặc máy chủ. |
