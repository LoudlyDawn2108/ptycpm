...
| NFR-R04 | Các thao tác cập nhật dữ liệu quan trọng phải tuân thủ nguyên tắc toàn bộ hoặc không thực hiện phần nào; số trường hợp dữ liệu dở dang hoặc bất nhất sau lỗi phải bằng 0. | SUPL-R04 |
