...
| UI-02 | Hệ thống phải áp dụng nhất quán font chữ mặc định, màu hiển thị cho từng loại thông báo và vị trí nút xác nhận trên các màn hình hoặc biểu mẫu cùng loại. | M | SUPL-U02a, SUPL-U02b, SUPL-U02c |
| UI-03 | Hệ thống phải hiển thị lỗi nhập liệu, lỗi nghiệp vụ và lỗi hệ thống bằng tiếng Việt; thông báo phải nêu rõ nguyên nhân hoặc điều kiện gây lỗi, bước người dùng cần thực hiện để tiếp tục, và với lỗi hệ thống phải kèm mã tra cứu duy nhất. | M | SUPL-U05, SUPL-U06 |
| UI-05 | Ở độ phân giải từ 1366×768 trở lên, 100% màn hình phải hiển thị tiêu đề trang, bộ lọc hoặc ô tìm kiếm (nếu có), vùng nội dung chính, nút thao tác chính và phân trang hoặc nút điều hướng (nếu có) trong vùng hiển thị mà không cần cuộn ngang. | E | SUPL-U09 |
| UI-06 | Ở độ phân giải từ 1024×768 đến dưới 1366×768, hệ thống phải cho phép thực hiện các tác vụ tìm kiếm hồ sơ, xem chi tiết hồ sơ, thêm mới hồ sơ và chỉnh sửa hồ sơ mà không cần cuộn ngang hoặc phóng to. | E | SUPL-U10 |
| UI-07a | Trên 100% form nhập liệu thuộc phạm vi yêu cầu, phím Tab phải di chuyển tuần tự giữa các trường có thể nhập theo thứ tự từ trên xuống dưới, từ trái sang phải. | N | SUPL-U11 |
| UI-07b | Trên 100% form nhập liệu thuộc phạm vi yêu cầu, phím Enter phải kích hoạt đúng nút hành động chính của biểu mẫu (Lưu, Thêm mới hoặc Cập nhật). | N | SUPL-U12 |
| UI-07c | 100% trang có cấu trúc danh sách → chi tiết → chỉnh sửa phải hiển thị breadcrumb và cho phép người dùng quay lại đúng cấp điều hướng tương ứng. | N | SUPL-U13 |
| UI-08 | Hệ thống phải hiển thị hộp thoại xác nhận trước 100% thao tác khóa hoặc mở khóa tài khoản, giải thể hoặc sáp nhập đơn vị, chấm dứt hợp đồng trước hạn, đánh dấu thôi việc, xóa hệ số lương, thay đổi trạng thái loại phụ cấp và thay đổi trạng thái loại hợp đồng. | M | SUPL-U14 |
...
| FR-ACC-08 | Hệ thống phải cho phép Quản trị viên gán vai trò cho tài khoản người dùng trong luồng tạo mới hoặc cập nhật tài khoản theo mô hình phân quyền của hệ thống. | Quản trị viên | FEAT 2.4, UC 4.5, UC 4.6 |
| FR-ACC-09 | Hệ thống phải cho phép Quản trị viên khóa hoặc mở khóa tài khoản người dùng theo quy tắc nghiệp vụ. | Quản trị viên | FEAT 2.5, UC 4.7 |
...
| Mã | Yêu cầu | Tác nhân chính | Truy vết nguồn |
| --- | --- | --- | --- |
| FR-ORG-01 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB tạo mới đơn vị tổ chức trong cơ cấu cây cha–con của hệ thống. | Quản trị viên, TCCB | FEAT 3.1, FEAT 3.2, UC 4.8 |
| FR-ORG-02 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB cập nhật thông tin của đơn vị tổ chức đã tồn tại. | Quản trị viên, TCCB | FEAT 3.3, UC 4.9 |
| FR-ORG-03 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB thay đổi trạng thái đơn vị tổ chức sang giải thể hoặc sáp nhập theo quy tắc nghiệp vụ. | Quản trị viên, TCCB | FEAT 3.4, UC 4.10 |
| FR-ORG-04 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB xem chi tiết thông tin của một đơn vị tổ chức, bao gồm trạng thái, nhân sự trực thuộc và lịch sử liên quan. | Quản trị viên, TCCB | FEAT 3.5, UC 4.11 |
| FR-ORG-05 | Hệ thống phải cho phép Phòng TCCB bổ nhiệm nhân sự vào đơn vị tổ chức phù hợp với trạng thái làm việc và trạng thái hợp đồng của nhân sự. | TCCB | FEAT 9.1, UC 4.38 |
| FR-ORG-06 | Hệ thống phải cho phép Phòng TCCB điều chuyển nhân sự từ đơn vị hiện tại sang đơn vị tổ chức khác theo quy tắc nghiệp vụ. | TCCB | FEAT 9.2, UC 4.38 A1 |
| FR-ORG-07 | Hệ thống phải cho phép Phòng TCCB bãi nhiệm nhân sự khỏi đơn vị tổ chức và cập nhật trạng thái công việc tương ứng. | TCCB | FEAT 9.3, UC 4.39 |

#### 7.3.2.3. Danh mục tham chiếu và hồ sơ nhân sự

| Mã | Yêu cầu | Tác nhân chính | Truy vết nguồn |
| --- | --- | --- | --- |
| FR-CFG-01 | Hệ thống phải cho phép Phòng TCCB thêm mới danh mục hệ số lương. | TCCB | FEAT 4.1, UC 4.13 |
| FR-CFG-02 | Hệ thống phải cho phép Phòng TCCB chỉnh sửa danh mục hệ số lương chưa bị ràng buộc bởi các điều kiện từ chối của hệ thống. | TCCB | FEAT 4.2, UC 4.14 |
| FR-CFG-03a | Hệ thống phải cho phép Phòng TCCB xóa danh mục hệ số lương khi danh mục chưa được sử dụng và đáp ứng quy tắc nghiệp vụ. | TCCB | FEAT 4.3, UC 4.15 |
| FR-CFG-03b | Hệ thống phải cho phép Phòng TCCB thay đổi trạng thái danh mục hệ số lương theo tình trạng sử dụng và quy tắc nghiệp vụ. | TCCB | FEAT 4.3, UC 4.16 |
| FR-CFG-04a | Hệ thống phải cho phép Phòng TCCB thêm mới danh mục loại phụ cấp. | TCCB | FEAT 4.4, UC 4.17 |
| FR-CFG-04b | Hệ thống phải cho phép Phòng TCCB chỉnh sửa danh mục loại phụ cấp đang ở trạng thái cho phép chỉnh sửa. | TCCB | FEAT 4.4, UC 4.18 |
| FR-CFG-04c | Hệ thống phải cho phép Phòng TCCB thay đổi trạng thái danh mục loại phụ cấp theo quy tắc nghiệp vụ. | TCCB | FEAT 4.4, UC 4.19 |
| FR-CFG-05a | Hệ thống phải cho phép Phòng TCCB thêm mới danh mục loại hợp đồng. | TCCB | FEAT 4.5, UC 4.20 |
| FR-CFG-05b | Hệ thống phải cho phép Phòng TCCB chỉnh sửa danh mục loại hợp đồng đang ở trạng thái cho phép chỉnh sửa. | TCCB | FEAT 4.5, UC 4.21 |
| FR-CFG-05c | Hệ thống phải cho phép Phòng TCCB thay đổi trạng thái danh mục loại hợp đồng theo quy tắc nghiệp vụ. | TCCB | FEAT 4.5, UC 4.22 |
| FR-HR-01 | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT tìm kiếm hồ sơ nhân sự bằng các từ khóa được hệ thống hỗ trợ. | TCCB, TCKT | FEAT 8.1, UC 4.29 |
| FR-HR-02 | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT lọc danh sách hồ sơ nhân sự theo nhiều tiêu chí nghiệp vụ. | TCCB, TCKT | FEAT 8.2, UC 4.30 |
| FR-HR-03 | Hệ thống phải cho phép Phòng TCCB tạo mới hồ sơ nhân sự bằng nhập tay hoặc import từ Excel và khởi tạo hồ sơ theo quy tắc nghiệp vụ. | TCCB | FEAT 8.3, UC 4.31 |
| FR-HR-05 | Hệ thống phải cho phép Phòng TCCB chỉnh sửa hồ sơ nhân sự chỉ khi hồ sơ đang ở trạng thái làm việc hợp lệ, và phải từ chối chỉnh sửa hồ sơ đã thôi việc. | TCCB | FEAT 8.4, UC 4.32 |
| FR-HR-06 | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT xem chi tiết hồ sơ nhân sự theo quyền hạn được cấp. | TCCB, TCKT | FEAT 8.7, UC 4.35 |
| FR-HR-07a | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT in hồ sơ nhân sự theo quyền được cấp. | TCCB, TCKT | FEAT 8.8, UC 4.36 |
| FR-HR-07b | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT xuất hồ sơ nhân sự ra Excel theo quyền được cấp. | TCCB, TCKT | FEAT 8.8, UC 4.36 A1 |
| FR-HR-08 | Hệ thống phải cho phép Phòng TCCB đánh dấu thôi việc cho nhân sự và cập nhật các trạng thái liên quan theo quy tắc nghiệp vụ. | TCCB | FEAT 8.5, UC 4.33 |
...
| FR-HR-10 | Hệ thống phải cho phép Phòng TCCB cấu hình ẩn/hiện các mục khen thưởng và kỷ luật trong hồ sơ nhân sự đối với các vai trò không thuộc Phòng TCCB. | TCCB | FEAT 8.9, UC 4.37 |

#### 7.3.2.4. Hợp đồng, đánh giá, đào tạo, báo cáo và tự phục vụ

| Mã | Yêu cầu | Tác nhân chính | Truy vết nguồn |
| --- | --- | --- | --- |
| FR-CON-01 | Hệ thống phải cho phép Phòng TCCB tạo hợp đồng lao động mới cho nhân sự đủ điều kiện theo loại hợp đồng, thời hạn và số lần ký được cấu hình. | TCCB | FEAT 7.1, UC 4.25 |
| FR-CON-02 | Hệ thống phải cho phép Phòng TCCB xem danh sách và chi tiết hợp đồng lao động của nhân sự. | TCCB | FEAT 7.2, UC 4.26 |
| FR-CON-03 | Hệ thống phải cho phép Phòng TCCB chỉnh sửa hợp đồng lao động khi hợp đồng đang ở trạng thái chưa có hiệu lực. | TCCB | FEAT 7.3, UC 4.27 |
| FR-CON-04 | Hệ thống phải cho phép Phòng TCCB chấm dứt trước hạn hợp đồng lao động đang còn hiệu lực và cập nhật trạng thái hợp đồng tương ứng. | TCCB | FEAT 7.4, UC 4.28 |
| FR-EVA-01 | Hệ thống phải cho phép Phòng TCCB ghi nhận đánh giá khen thưởng hoặc kỷ luật cho nhân sự đang còn làm việc. | TCCB | FEAT 10.1, UC 4.40 |
| FR-EVA-02 | Hệ thống phải cho phép Phòng TCCB xem lịch sử đánh giá khen thưởng/kỷ luật của từng nhân sự. | TCCB | FEAT 10.2, UC 4.41 |
| FR-EVA-03 | Hệ thống phải cho phép Phòng TCCB tìm kiếm và lọc danh sách đánh giá khen thưởng/kỷ luật theo tiêu chí được hỗ trợ. | TCCB | FEAT 10.3, UC 4.42 |
| FR-TRN-01 | Hệ thống phải cho phép Phòng TCCB mở khóa đào tạo mới cho cán bộ, giảng viên. | TCCB | FEAT 11.1, UC 4.43 |
| FR-TRN-02 | Hệ thống phải cho phép Phòng TCCB chỉnh sửa khóa đào tạo theo trạng thái và ràng buộc nghiệp vụ của khóa học. | TCCB | FEAT 11.2, UC 4.44 |
| FR-TRN-03 | Hệ thống phải cho phép Phòng TCCB xem chi tiết khóa đào tạo và danh sách người đã đăng ký. | TCCB | FEAT 11.3, UC 4.45 |
| FR-TRN-04 | Hệ thống phải cho phép Phòng TCCB ghi nhận kết quả đào tạo và lưu chứng chỉ vào hồ sơ nhân sự của người tham gia. | TCCB | FEAT 11.4, UC 4.46 |
| FR-RPT-01 | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT xem các báo cáo, thống kê về nhân sự, hợp đồng, đánh giá, đào tạo và bổ nhiệm. | TCCB, TCKT | FEAT 5.1–5.4, UC 4.23 |
| FR-RPT-02 | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT xuất báo cáo, thống kê theo phạm vi dữ liệu đang được áp dụng. | TCCB, TCKT | FEAT 5.1–5.4, UC 4.23 A1 |
| FR-SELF-01 | Hệ thống phải cho phép cán bộ, giảng viên và nhân viên xem thông tin cá nhân của chính mình. | Người dùng | FEAT 12.1, UC 4.47 |
| FR-SELF-02 | Hệ thống phải cho phép cán bộ, giảng viên và nhân viên xem thông tin chi tiết đơn vị đang công tác và cơ cấu trực thuộc liên quan. | Người dùng | FEAT 12.2, UC 4.48 |
| FR-SELF-03 | Hệ thống phải cho phép cán bộ, giảng viên và nhân viên đăng ký hoặc hủy đăng ký tham gia khóa đào tạo đang mở đăng ký, còn chỉ tiêu và đáp ứng quy tắc nghiệp vụ. | Người dùng | FEAT 12.3, UC 4.49 |
| FR-SELF-04 | Hệ thống phải cho phép cán bộ, giảng viên và nhân viên xem danh sách các khóa đào tạo đã đăng ký cùng trạng thái tham gia và kết quả đào tạo của mình. | Người dùng | FEAT 12.4, UC 4.50 |
...
| Mã | Yêu cầu | Truy vết nguồn |
| --- | --- | --- |
| NFR-U01 | Sau tối đa 2 giờ đào tạo hướng dẫn, ít nhất 95% người dùng mới thuộc phòng TCCB phải hoàn thành các tác vụ tìm kiếm, xem chi tiết và cập nhật hồ sơ nhân sự mà không cần người hướng dẫn trả lời câu hỏi, nhắc bước tiếp theo hoặc thao tác hộ; ít nhất 95% người dùng mới thuộc phòng TCKT phải hoàn thành các tác vụ tìm kiếm, xem chi tiết và xuất hồ sơ nhân sự mà không cần người hướng dẫn trả lời câu hỏi, nhắc bước tiếp theo hoặc thao tác hộ. | SUPL-U03, SUPL-U04 |
| NFR-U02 | Chức năng tìm kiếm hồ sơ nhân sự phải cho phép kết hợp đồng thời ít nhất 3 tiêu chí lọc; từ danh sách hồ sơ, người dùng phải mở được chi tiết của 1 hồ sơ trong tối đa 3 bước chức năng. | SUPL-U07, SUPL-U08 |
...
| NFR-R02 | Sau sự cố crash hoặc gián đoạn ngoài kế hoạch, hệ thống phải phục hồi khả năng phục vụ request thành công trong tối đa 15 phút. | SUPL-P07a |
| NFR-R03 | Hệ thống phải sao lưu dữ liệu ít nhất mỗi 24 giờ, lưu giữ bản sao lưu tối thiểu 30 ngày, bảo đảm RPO không quá 24 giờ, RTO không quá 4 giờ và tỷ lệ backup thành công tối thiểu 99%. | SUPL-R03a, SUPL-R03b, SUPL-R03c, SUPL-R03d |
...
| NFR-R05 | Đối với form có dữ liệu nhập dở, hệ thống phải cảnh báo trước 5 phút khi phiên sắp hết hạn để người dùng có cơ hội lưu dữ liệu đang nhập và phải khôi phục được tối thiểu 95% dữ liệu gần nhất sau khi người dùng đăng nhập lại. | SUPL-R05a, SUPL-R05b |

#### 7.3.3.4. Yêu cầu về hiệu năng

Các chỉ tiêu hiệu năng chỉ áp dụng cho một use case cụ thể, như thời gian hiển thị chi tiết hồ sơ, chuẩn bị dữ liệu in và xuất Excel hồ sơ, được đặc tả tại Yêu cầu đặc biệt của UC 4.35 và UC 4.36 thay vì lặp lại tại đây.

| Mã | Yêu cầu | Truy vết nguồn |
| --- | --- | --- |
| NFR-P01 | P95 response time của các thao tác xem danh sách, xem chi tiết, thêm mới và chỉnh sửa trên các màn hình hợp đồng và hồ sơ nhân sự phải không vượt quá 1 giây với 0–10 người dùng đồng thời, 2 giây với 11–50 người dùng đồng thời và 5 giây với 51–100 người dùng đồng thời. | SUPL-P01 |
| NFR-P01b | Time to Interactive (TTI) của các thao tác xem danh sách, xem chi tiết, thêm mới và chỉnh sửa trên các màn hình hợp đồng và hồ sơ nhân sự phải không vượt quá 1,5 giây với 0–10 người dùng đồng thời, 3 giây với 11–50 người dùng đồng thời và 6 giây với 51–100 người dùng đồng thời. | SUPL-P01b |
| NFR-P02 | Hệ thống phải hỗ trợ tối thiểu 100 người dùng đồng thời trong giờ cao điểm; thời gian phản hồi của các thao tác xem danh sách, xem chi tiết, thêm mới và chỉnh sửa tại mức 100 người dùng đồng thời không được tăng quá 50% so với tải một người dùng trong cùng điều kiện đo. | SUPL-P02 |
...
| NFR-P05 | Upload tệp đính kèm phải hoàn thành trong tối đa 5 giây và download trong tối đa 3 giây với file không quá 5 MB, hoặc upload tối đa 10 giây và download tối đa 6 giây với file trên 5 MB đến 10 MB, trên mạng LAN 1 Gbps và ở mức không quá 10 người dùng đồng thời. | SUPL-P05 |
| NFR-P07 | Toàn bộ stack phải khởi động lại trong tối đa 10 phút sau lệnh restart có chủ đích. | SUPL-P07b |
...
| Mã | Yêu cầu | Truy vết nguồn |
| --- | --- | --- |
| NFR-S01 | Hệ thống phải cho phép quản trị viên thêm mới, chỉnh sửa và thay đổi trạng thái hệ số lương, loại phụ cấp và loại hợp đồng qua giao diện cấu hình. | SUPL-S01 |
| NFR-S02 | Hệ thống phải cung cấp tài liệu API mô tả 100% các API mà giao diện web đang sử dụng, bao gồm phương thức, đường dẫn truy cập (URL), tham số, dữ liệu trả về và mã lỗi. | SUPL-S02 |
| NFR-S03 | Hệ thống phải cung cấp tài liệu triển khai bao gồm yêu cầu môi trường, cài đặt, cấu hình, khởi động, sao lưu, khôi phục và xử lý lỗi triển khai. | SUPL-S03 |
| NFR-S04 | Hệ thống phải cung cấp hướng dẫn sử dụng riêng cho Quản trị viên, Phòng TCCB, Phòng TCKT và nhóm người dùng Cán bộ/Giảng viên/Nhân viên. | SUPL-S04 |
| NFR-S05 | Trong không quá 1 phút kể từ khi quản trị viên lưu thay đổi cấu hình hệ số lương, loại phụ cấp hoặc loại hợp đồng, giá trị mới phải xuất hiện trên màn hình cấu hình tương ứng và trong danh sách chọn của các màn hình thêm mới hoặc chỉnh sửa hồ sơ nhân sự, hợp đồng lao động có sử dụng danh mục đó. | SUPL-S05 |
| NFR-S06 | Hệ thống phải phân loại và ghi log máy chủ ở tối thiểu 4 mức: ERROR, WARNING, INFO và DEBUG. | SUPL-S06 |
| NFR-S07 | Mỗi bản ghi log mức ERROR phải chứa timestamp, severity, request ID và stack trace. | SUPL-S07 |
| NFR-S08 | Ít nhất 95% bản ghi log phát sinh trong phiên đã xác thực phải chứa user ID. | SUPL-S08 |
| NFR-S09 | Khi chạy đồng thời trên tối thiểu 2 nút ứng dụng trong cùng một môi trường, hệ thống phải duy trì đúng hành vi đăng nhập, tìm kiếm hồ sơ nhân sự, xem chi tiết hồ sơ, thêm mới hoặc chỉnh sửa hồ sơ, thay đổi trạng thái loại hợp đồng và duy trì trạng thái phiên khi các request của cùng một phiên đi qua các nút khác nhau. | SUPL-S09a, SUPL-S09b, SUPL-S09c, SUPL-S09d, SUPL-S09e, SUPL-S09f, SUPL-S10 |
...
- Trong baseline hiện tại, danh mục và ánh xạ Use Case được tổng hợp tại `requirement-modeling.md`; nội dung UCS chi tiết đang được phân bố giữa `output/final-report.md` (UC 4.1–4.24 và UC 4.38–4.50) và `output/Tung/uc-tung.md` (UC 4.25–4.37).
