...
| 4 | displayKetQuaLoc() | List danhSach | Void | Hiển thị kết quả lọc/tìm kiếm |
...
| 5 | displayKetQuaTimKiem() | List danhSach | Void | Hiển thị kết quả tìm kiếm đánh giá |
...
| 5 | findAllTaiKhoan() | Không | List | Lấy danh sách toàn bộ tài khoản |
...
| 4 | getDonViTree() | Không | List | Lấy cây cơ cấu tổ chức |
...
| 4 | getLichSuBoNhiem() | Long nhanSuId | List | Lấy lịch sử bổ nhiệm của nhân sự |
...
| 5 | getAllHeSoLuong() | Không | List | Lấy toàn bộ hệ số lương |
...
| 9 | getAllLoaiPhuCap() | Không | List | Lấy toàn bộ loại phụ cấp |
...
| 13 | getAllLoaiHopDong() | Không | List | Lấy toàn bộ loại hợp đồng |
...
| 4 | searchHoSo() | String keyword | List | Tìm kiếm hồ sơ theo từ khóa |
| 5 | filterHoSo() | Map filters | List | Lọc hồ sơ theo nhiều tiêu chí |
...
| 4 | getHopDongByNhanSu() | Long nhanSuId | List | Lấy danh sách hợp đồng của nhân sự |
...
| 2 | getDanhGiaByNhanSu() | Long nhanSuId | List | Lấy danh sách đánh giá của nhân sự |
| 3 | searchDanhGia() | Map filters | List | Tìm kiếm/lọc đánh giá |
| 4 | getLichSuDanhGia() | Long nhanSuId | List | Lấy lịch sử đánh giá theo thời gian |
...
| 3 | getAllKhoaDaoTao() | Không | List | Lấy danh sách khóa đào tạo |
...
| 6 | getDangKyByNhanSu() | Long nhanSuId | List | Lấy danh sách đăng ký của nhân sự |
...
| 2 | getNhatKy() | Map filters | List | Lấy danh sách nhật ký theo bộ lọc |
...
| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getCauHinh() | Không | List | Lấy danh sách cấu hình hệ thống |
| 2 | updateCauHinh() | Long id, String giaTri | CauHinhHeThong | Cập nhật cấu hình hệ thống |
| 3 | getCauHinhByVaiTro() | VaiTro vaiTro | List | Lấy cấu hình áp dụng cho vai trò |
...
| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về toàn bộ các vai trò |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | DANG\_HOAT\_DONG | TrangThaiTaiKhoan | Tài khoản đang được phép sử dụng |
| 2 | BI\_KHOA | TrangThaiTaiKhoan | Tài khoản bị khóa, không thể đăng nhập |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái tài khoản |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | DANG\_HOAT\_DONG | TrangThaiDonVi | Đơn vị đang hoạt động bình thường |
| 2 | GIAI\_THE | TrangThaiDonVi | Đơn vị đã giải thể |
| 3 | SAP\_NHAP | TrangThaiDonVi | Đơn vị đã sáp nhập vào đơn vị khác |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái đơn vị |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | HOI\_DONG | LoaiDonVi | Hội đồng |
| 2 | BAN | LoaiDonVi | Ban |
| 3 | KHOA | LoaiDonVi | Khoa |
| 4 | PHONG | LoaiDonVi | Phòng |
| 5 | BO\_MON | LoaiDonVi | Bộ môn |
| 6 | PHONG\_THI\_NGHIEM | LoaiDonVi | Phòng thí nghiệm |
| 7 | TRUNG\_TAM | LoaiDonVi | Trung tâm |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập loại đơn vị |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | CHUA\_CO\_HIEU\_LUC | TrangThaiHopDong | Hợp đồng đã tạo nhưng chưa đến ngày hiệu lực |
| 2 | CON\_HIEU\_LUC | TrangThaiHopDong | Hợp đồng đang có hiệu lực |
| 3 | CHO\_GIA\_HAN | TrangThaiHopDong | Hợp đồng đang ở giai đoạn chờ gia hạn |
| 4 | HET\_HIEU\_LUC | TrangThaiHopDong | Hợp đồng đã hết hiệu lực |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái hợp đồng |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | DANG\_CHO\_XET | TrangThaiLamViec | Nhân sự chưa được bố trí công tác chính thức |
| 2 | DANG\_CONG\_TAC | TrangThaiLamViec | Nhân sự đang công tác tại đơn vị |
| 3 | DA\_THOI\_VIEC | TrangThaiLamViec | Nhân sự đã thôi việc |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái làm việc |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | CHUA\_HOP\_DONG | TrangThaiHopDongNhanSu | Nhân sự chưa có hợp đồng |
| 2 | CON\_HIEU\_LUC | TrangThaiHopDongNhanSu | Nhân sự đang có hợp đồng còn hiệu lực |
| 3 | HET\_HIEU\_LUC | TrangThaiHopDongNhanSu | Toàn bộ hợp đồng của nhân sự đã hết hiệu lực |
| 4 | CHO\_GIA\_HAN | TrangThaiHopDongNhanSu | Nhân sự đang ở giai đoạn chờ gia hạn hợp đồng |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái hợp đồng nhân sự |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | DANG\_MO\_DANG\_KY | TrangThaiKhoaDaoTao | Khóa đang mở cho đăng ký |
| 2 | DANG\_DAO\_TAO | TrangThaiKhoaDaoTao | Khóa đang diễn ra |
| 3 | DA\_HOAN\_THANH | TrangThaiKhoaDaoTao | Khóa đã hoàn thành |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái khóa đào tạo |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | DA\_DANG\_KY | TrangThaiThamGia | Đã đăng ký tham gia khóa học |
| 2 | DANG\_HOC | TrangThaiThamGia | Đang học hoặc đang tham gia |
| 3 | HOAN\_THANH | TrangThaiThamGia | Hoàn thành khóa đào tạo |
| 4 | KHONG\_DAT | TrangThaiThamGia | Không đạt yêu cầu sau đào tạo |
| 5 | DA\_HUY | TrangThaiThamGia | Đã hủy đăng ký hoặc bị hủy tham gia |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái tham gia |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | DANG\_NHAP | LoaiHanhDong | Hành động đăng nhập |
| 2 | DANG\_XUAT | LoaiHanhDong | Hành động đăng xuất |
...
| 7 | PHAN\_QUYEN | LoaiHanhDong | Hành động phân quyền tài khoản |
| 8 | THAY\_DOI\_TRANG\_THAI | LoaiHanhDong | Hành động thay đổi trạng thái đối tượng |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập loại hành động |
...
| STT | Thuộc tính | Kiểu dữ liệu | Mô tả |
| --- | --- | --- | --- |
| 1 | DANG\_SU\_DUNG | TrangThaiDanhMuc | Danh mục đang được phép chọn và áp dụng |
| 2 | NGUNG\_SU\_DUNG | TrangThaiDanhMuc | Danh mục bị ngừng sử dụng nhưng vẫn giữ lịch sử |

**Bảng phương thức:**

| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập trạng thái danh mục |
...
| STT | Phương thức | Tham số | Kiểu trả về | Mô tả |
| --- | --- | --- | --- | --- |
| 1 | getValues() | Không | List | Trả về tập giá trị giới tính |
| 2 | fromValue() | String value | GioiTinh | Chuyển chuỗi sang giá trị giới tính |

## 5.2. Biểu đồ lớp tổng quát

![Image: image_006](./report_images/image_006.png)

## 5.3. Bảng tổng hợp các lớp (Class Inventory)
...
| UC 4.40 | KhoaDaoTaoPage | DaoTaoController, NhatKyController | DangKyDaoTao, KhoaDaoTao, TrangThaiThamGia, LoaiHanhDong | Đăng ký/hủy đăng ký khóa đào tạo; trạng thái DA\_HUY hỗ trợ trường hợp hủy. |
