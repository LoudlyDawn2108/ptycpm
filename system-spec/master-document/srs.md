...
| NFR-R02 | Sau sự cố crash hoặc mất dịch vụ ngoài kế hoạch của hệ thống mà không yêu cầu phục hồi từ bản sao lưu gần nhất, hệ thống phải phục vụ lại được request đầu tiên thành công trong tối đa 15 phút. | SUPL-P07a |
...
| NFR-R04 | Các thao tác tạo/chỉnh sửa hồ sơ nhân sự, tạo/chỉnh sửa/chấm dứt hợp đồng và cập nhật trạng thái thôi việc phải tuân thủ nguyên tắc toàn bộ hoặc không thực hiện phần nào; số trường hợp dữ liệu dở dang hoặc bất nhất sau lỗi phải bằng 0. | SUPL-R04 |
| NFR-R05 | Đối với form có dữ liệu đã nhập nhưng chưa lưu, hệ thống phải hiển thị cảnh báo tối thiểu 5 phút trước khi phiên tự động hết hạn trong 100% phiên được kiểm thử và phải khôi phục được dữ liệu nháp trong tối thiểu 95% trường hợp kiểm thử sau khi người dùng đăng nhập lại. | SUPL-R05a, SUPL-R05b |
...
| NFR-P07 | Toàn bộ stack phải đạt trạng thái sẵn sàng phục vụ trong tối đa 10 phút sau lệnh restart có chủ đích. | SUPL-P07b |
