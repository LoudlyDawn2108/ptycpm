...
- **Mục 7.3.4** mô tả các quy tắc quản lý requirement, bao gồm truy vết, tổ chức requirement, thuộc tính requirement và các giả định/phụ thuộc dùng để quản lý bộ yêu cầu.
...
| Nền tảng truy cập web | Cung cấp ứng dụng web nhiều người dùng; mọi thao tác nghiệp vụ được xử lý qua API | FEAT 14.1 |
| Quản trị tài khoản | Tìm kiếm, thêm, sửa, khóa/mở khóa tài khoản, phân quyền | FEAT 2.1–2.6 |
| Quản lý cơ cấu tổ chức | Thiết lập cây đơn vị, cập nhật thông tin đơn vị, giải thể/sáp nhập | FEAT 15.1, FEAT 3.1–3.4 |
...
| UI-02 | Hệ thống phải áp dụng nhất quán font chữ mặc định, màu hiển thị cho từng loại thông báo và vị trí nút xác nhận trên các màn hình hoặc biểu mẫu cùng loại. | M | SUPL-U02, SUPL-U03, SUPL-U04 |
| UI-03 | Hệ thống phải hiển thị lỗi nhập liệu, lỗi nghiệp vụ và lỗi hệ thống bằng tiếng Việt; thông báo phải nêu rõ nguyên nhân hoặc điều kiện gây lỗi, bước người dùng cần thực hiện để tiếp tục, và với lỗi hệ thống phải kèm mã tra cứu duy nhất. | M | SUPL-U07, SUPL-U08 |
| UI-05 | Ở độ phân giải từ 1366×768 trở lên, 100% màn hình phải hiển thị tiêu đề trang, bộ lọc hoặc ô tìm kiếm (nếu có), vùng nội dung chính, nút thao tác chính và phân trang hoặc nút điều hướng (nếu có) trong vùng hiển thị mà không cần cuộn ngang. | E | SUPL-U11 |
| UI-06 | Ở độ phân giải từ 1024×768 đến dưới 1366×768, hệ thống phải cho phép thực hiện các tác vụ tìm kiếm hồ sơ, xem chi tiết hồ sơ, thêm mới hồ sơ và chỉnh sửa hồ sơ mà không cần cuộn ngang hoặc phóng to. | E | SUPL-U12 |
| UI-07a | Trên 100% form nhập liệu thuộc phạm vi yêu cầu, phím Tab phải di chuyển tuần tự giữa các trường có thể nhập theo thứ tự từ trên xuống dưới, từ trái sang phải. | N | SUPL-U13 |
| UI-07b | Trên 100% form nhập liệu thuộc phạm vi yêu cầu, phím Enter phải kích hoạt đúng nút hành động chính của biểu mẫu (Lưu, Thêm mới hoặc Cập nhật). | N | SUPL-U14 |
| UI-07c | 100% trang có cấu trúc danh sách → chi tiết → chỉnh sửa phải hiển thị breadcrumb và cho phép người dùng quay lại đúng cấp điều hướng tương ứng. | N | SUPL-U15 |
| UI-08 | Hệ thống phải hiển thị hộp thoại xác nhận trước 100% thao tác khóa hoặc mở khóa tài khoản, giải thể hoặc sáp nhập đơn vị, chấm dứt hợp đồng trước hạn, đánh dấu thôi việc, xóa hệ số lương, thay đổi trạng thái loại phụ cấp và thay đổi trạng thái loại hợp đồng. | M | SUPL-U16 |
...
| FR-ACC-08 | Hệ thống phải cho phép Quản trị viên gán vai trò cho tài khoản người dùng theo mô hình phân quyền của hệ thống. | Quản trị viên | FEAT 2.4, UC 4.5, UC 4.6 |
...
| FR-ACC-10 | Hệ thống phải tự động khóa tài khoản liên kết khi nhân sự tương ứng được cập nhật sang trạng thái thôi việc. | Hệ thống | FEAT 2.6, UC 4.7 A2 |
...
| Mã | Yêu cầu | Tác nhân chính | Truy vết nguồn |
| --- | --- | --- | --- |
| FR-ORG-01 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB tạo mới đơn vị tổ chức trong cơ cấu cây cha–con của hệ thống. | Quản trị viên, Phòng TCCB | FEAT 15.1, FEAT 3.1, UC 4.8 |
| FR-ORG-02 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB cập nhật thông tin của đơn vị tổ chức đã tồn tại. | Quản trị viên, Phòng TCCB | FEAT 3.2, UC 4.9 |
| FR-ORG-03 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB thay đổi trạng thái đơn vị tổ chức sang giải thể hoặc sáp nhập theo quy tắc nghiệp vụ. | Quản trị viên, Phòng TCCB | FEAT 3.3, FEAT 3.5, UC 4.10, UC 4.12 |
| FR-ORG-04 | Hệ thống phải cho phép Quản trị viên và Phòng TCCB xem chi tiết thông tin của một đơn vị tổ chức, bao gồm trạng thái, nhân sự trực thuộc và lịch sử liên quan. | Quản trị viên, Phòng TCCB | FEAT 3.4, UC 4.11 |
...
| FR-HR-04 | Khi tạo mới hồ sơ nhân sự, hệ thống phải tự động cấp mã cán bộ duy nhất theo mẫu mã đang được cấu hình áp dụng, đồng thời khởi tạo trạng thái hợp đồng là “Chưa hợp đồng” và trạng thái làm việc là “Đang chờ xét”. | Phòng TCCB, Hệ thống | FEAT 8.3, UC 4.31 |
...
| FR-HR-07b | Hệ thống phải cho phép Phòng TCCB và Phòng TCKT xuất hồ sơ nhân sự ra Excel theo quyền được cấp. | Phòng TCCB, Phòng TCKT | FEAT 8.8, UC 4.36 A1 |
...
| SR-F05 | Hệ thống phải áp dụng quy tắc thay đổi trạng thái giữa “Đang sử dụng” và “Ngừng sử dụng” đối với danh mục loại phụ cấp và loại hợp đồng; hệ thống không được xóa các mục đã được tham chiếu trong dữ liệu nghiệp vụ. | SUPL-F07 |
...
| Mã | Yêu cầu | Truy vết nguồn |
| --- | --- | --- |
| NFR-U01 | Sau tối đa 2 giờ đào tạo hướng dẫn, ít nhất 95% người dùng mới thuộc phòng TCCB phải hoàn thành các tác vụ tìm kiếm, xem chi tiết và cập nhật hồ sơ nhân sự mà không cần người hướng dẫn trả lời câu hỏi, nhắc bước tiếp theo hoặc thao tác hộ; ít nhất 95% người dùng mới thuộc phòng TCKT phải hoàn thành các tác vụ tìm kiếm, xem chi tiết và xuất hồ sơ nhân sự mà không cần người hướng dẫn trả lời câu hỏi, nhắc bước tiếp theo hoặc thao tác hộ. | SUPL-U05, SUPL-U06 |
| NFR-U02 | Chức năng tìm kiếm hồ sơ nhân sự phải cho phép kết hợp đồng thời ít nhất 3 tiêu chí lọc; từ danh sách hồ sơ, người dùng phải mở được chi tiết của 1 hồ sơ trong tối đa 3 bước chức năng. | SUPL-U09, SUPL-U10 |
...
| NFR-R02 | Sau sự cố crash hoặc mất dịch vụ ngoài kế hoạch của hệ thống mà không yêu cầu phục hồi từ bản sao lưu gần nhất, hệ thống phải phục vụ lại được request đầu tiên thành công trong tối đa 15 phút. | SUPL-P06 |
| NFR-R03 | Hệ thống phải sao lưu dữ liệu ít nhất mỗi 24 giờ, lưu giữ bản sao lưu tối thiểu 30 ngày, bảo đảm RPO không quá 24 giờ, RTO không quá 4 giờ và tỷ lệ backup thành công tối thiểu 99%. | SUPL-R02, SUPL-R03, SUPL-R04, SUPL-R05 |
| NFR-R04 | Các thao tác tạo/chỉnh sửa hồ sơ nhân sự, tạo/chỉnh sửa/chấm dứt hợp đồng và cập nhật trạng thái thôi việc phải tuân thủ nguyên tắc toàn bộ hoặc không thực hiện phần nào; số trường hợp dữ liệu dở dang hoặc bất nhất sau lỗi phải bằng 0. | SUPL-R06 |
| NFR-R05 | Đối với form có dữ liệu đã nhập nhưng chưa lưu, hệ thống phải hiển thị cảnh báo tối thiểu 5 phút trước khi phiên tự động hết hạn trong 100% phiên được kiểm thử và phải khôi phục được dữ liệu nháp trong tối thiểu 95% trường hợp kiểm thử sau khi người dùng đăng nhập lại. | SUPL-R07, SUPL-R08 |
...
| NFR-P01b | Time to Interactive (TTI) của các thao tác xem danh sách, xem chi tiết, thêm mới và chỉnh sửa trên các màn hình hợp đồng và hồ sơ nhân sự phải không vượt quá 1,5 giây với 0–10 người dùng đồng thời, 3 giây với 11–50 người dùng đồng thời và 6 giây với 51–100 người dùng đồng thời. | SUPL-P02 |
| NFR-P02 | Hệ thống phải hỗ trợ tối thiểu 100 người dùng đồng thời trong giờ cao điểm; thời gian phản hồi của các thao tác xem danh sách, xem chi tiết, thêm mới và chỉnh sửa tại mức 100 người dùng đồng thời không được tăng quá 50% so với tải một người dùng trong cùng điều kiện đo. | SUPL-P03 |
| NFR-P04 | Chức năng tìm kiếm và lọc phải trả kết quả trong tối đa 2 giây với tập dữ liệu đến 10.000 bản ghi và tối đa 5 giây với tập dữ liệu đến 50.000 bản ghi, ở mức không quá 50 người dùng đồng thời. | SUPL-P04 |
...
| NFR-P07 | Toàn bộ stack phải đạt trạng thái sẵn sàng phục vụ trong tối đa 10 phút sau lệnh restart có chủ đích. | SUPL-P07 |
...
| NFR-SE10 | Mật khẩu người dùng phải được lưu ở dạng không thể khôi phục nguyên văn; số mật khẩu lưu ở dạng văn bản thuần phải bằng 0. | SUPL-F08 |
...
| Supplementary Requirement | SUPL | Mô tả yêu cầu cross-cutting, NFR và constraint | Nguồn chuẩn: `suplementary-requirement.md` |
| Metric / Acceptance Criteria | Metric | Lượng hóa cách xác minh SUPL | Nguồn chuẩn: `suplementary-requirement.md` (phần metric) |
...
- Trong baseline hiện tại, **FEAT 14.1** được truy vết tới **SUPL-DC01** như một ràng buộc kiến trúc; mục này không có **UC** riêng.
